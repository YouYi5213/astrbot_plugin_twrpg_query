...
TAG = "v1.0.9"
COMMIT_MESSAGE = "修复重复 ID 导致装备名显示异常，版本 1.0.9"
RELEASE_BODY = """## 更新内容

- 修复部分装备在「可合成物品」等区块显示为 `@Old Quest` 的问题
- 同一物品 ID 存在重复数据时，优先保留真实装备条目（如「神煞者印章」「阿瓦隆护灵之翼」）

## 示例

查询「奥义之核」时，「可合成物品」中「神煞者印章」不再误显示为 `@Old Quest`。
"""
