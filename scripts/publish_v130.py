...
TAG = "v1.3.0"
COMMIT_MESSAGE = "云存档背包图标网格展示，修复加载与精简配置，版本 1.3.0"
RELEASE_BODY = """## 新增

- 云存档「背包 / 仓库 / 携带」改为图标网格图片 + 标题文字

## 修复

- 修复插件加载失败：`StarTools.get_data_dir()` 仅在 `main.py` 调用

## 变更

- 移除 WebUI 配置项 `cloud_max_items_display`（内置单次最多展示 40 件）
"""
