...
TAG = "v1.1.2"
COMMIT_MESSAGE = "英雄卡片展示召唤物技能，版本 1.1.2"
RELEASE_BODY = """## 更新内容

- 英雄卡片追加召唤物技能：牧师（拉古尔）、炼金术士（无知）、风法（风之守护者）、巫术师（亚马罗斯）
- 精灵召唤师五元素精灵分区展示（熔岩 / 水殄 / 闪电 / 自然 / 混沌）
- 多精灵时合并重复展示的「返回」技能，卡片更紧凑

## 示例

- `英雄 牧师` → 本体技能 + 召唤 · 拉古尔
- `英雄 精灵召唤师` → 本体技能 + 召唤精灵（五元素分区）
"""
