...
TAG = "v1.2.2"
COMMIT_MESSAGE = "云存档 handler 仅保留在 main.py，修复加载失败，版本 1.2.2"
RELEASE_BODY = """## 修复

- 所有 `@filter` 云存档指令注册在 `main.py`（Star 入口）
- `core/cloud_service.py` 仅含业务逻辑，无装饰器
- 修复 `Unable to resolve metadata for module ... core.cloud_save`
"""
