...
TAG = "v1.1.4"
COMMIT_MESSAGE = "新增 BOSS 掉落查询，版本 1.1.4"
RELEASE_BODY = """## 更新内容

- 新增 BOSS 掉落查询：`世界BOSS <名称>` 展示 BOSS 阶段与掉落物品及掉率
- 收录常见 BOSS 别称（盖亚/土、判/判官、黑天、巫妖、小高、法爷等）

## 示例

- `世界BOSS 土灵战神盖亚` → 显示 [爵土马判] 阶段及掉落列表
- `世界BOSS 盖亚` / `世界BOSS 土` → 同上
- `世界BOSS 判官` → 灵魂收割者 斯蒂里克斯
"""
